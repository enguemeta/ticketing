...
import { validateRequest, requiredAuth, NotFoundError, BadRequestError } from "@4b-wins/common";
...
const EXPIRATION_WINDOW_SECONDS: any = 15 * 60;
...
router.post("/api/orders", requiredAuth, [
   ...
   async(req: Request, res: Response) => {
     ...
     const isReserved: any = await ticket.isReserved();
       if(isReserved) {
